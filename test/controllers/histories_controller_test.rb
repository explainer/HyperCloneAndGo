...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { start_time: @history.start_time, stop_time: @history.stop_time, valve_id: @history.valve_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { start_time: @history.start_time, stop_time: @history.stop_time, valve_id: @history.valve_id } }
